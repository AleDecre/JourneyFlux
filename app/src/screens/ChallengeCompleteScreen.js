...
const ChallengeCompleteScreen = ({ route, navigation }) => {
  ...
  const handleShare = async () => {
    try {
      const shareText = `🎯 Ho completato "${challenge?.title}" su JourneyFlux! Sfida incredibile che svela i segreti nascosti d'Italia. 🇮🇹✨ #JourneyFlux #ItaliaSegreta`;
      await Share.share({
        message: shareText,
        url: 'https://journeyflux.it'
      });
    } catch (error) {
          ...
          >
            ...
            <View style={styles.contentCard}>
              <View style={styles.contentHeader}>
                <Text style={styles.contentIcon}>{challenge?.image}</Text>
                <Text style={styles.contentType}>Sfida</Text>
              </View>
            ...
            {showSocialPreview && (
              <Animated.View style={styles.socialPreview}>
                <View style={styles.storyCard}>
                  ...
                  >
                    <Text style={styles.storyEmoji}>{challenge?.image}</Text>
